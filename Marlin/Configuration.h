...
#define STRING_CONFIG_H_AUTHOR "(mshipman, SV06)" // Who made the changes.
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 10 // (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print.
#endif
